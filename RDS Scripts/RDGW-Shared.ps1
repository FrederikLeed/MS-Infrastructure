<#
    ...
    NOTE..
    For security reasons having both Tier 0 and Tier 1 users use the same RD Gateway servers is not recommended.
    If Tier 0 remote access is needed, please install gateways in both Tiers, or use PAW !
